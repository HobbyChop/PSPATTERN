...
enum  GUIEventType { ET_NONE, ET_MOUSEDOWN, ET_MOUSEUP, ET_MOUSEMOVE , ET_RESIZE ,ET_KEYUP, ET_KEYDOWN,ET_IDLE, ET_PADBUTTONUP,ET_PADBUTTONDOWN, ET_PLAYERUPDATE,ET_SYSQUIT,ET_PADANALOGFLICK};
