...
#define SIP_ATTACK    		MAKE_FOURCC('S','A','T','K')
#define SIP_DECAY     		MAKE_FOURCC('S','D','E','C')
#define SIP_SUSTAIN   		MAKE_FOURCC('S','S','U','S')
#define SIP_RELEASE   		MAKE_FOURCC('S','R','E','L')
...
protected:
		...
		void startAmpEnv(renderParams *rp) ;
		void releaseAmpEnv(renderParams *rp) ;
