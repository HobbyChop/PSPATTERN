...
const char *scaleNames[scaleCount] = {// was "None (Chromatic)", which the
                                     // project screen could only show as
                                     // "None (Chromat"
                                     "Chromatic",
                                     "Acoustic",
                                     "Adonal malakh",
                                     ...
                                     "Major pentatonic",
                                     "Melodic minor",
                                     // "Melodic minor (asc)" until the
                                     // project screen could show it apart
                                     // from plain "Melodic minor"
                                     "Melodic asc",
                                     "Minor pentatonic",
                                     "Mixolydian",
                                     "Neapolitan major",
